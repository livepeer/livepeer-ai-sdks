...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LivepeerAiRunner.HTTPValidationError();
  });
  ...
  describe('HTTPValidationError', function() {
    it('should create an instance of HTTPValidationError', function() {
      ...
      //var instance = new LivepeerAiRunner.HTTPValidationError();
      //expect(instance).to.be.a(LivepeerAiRunner.HTTPValidationError);
    });
