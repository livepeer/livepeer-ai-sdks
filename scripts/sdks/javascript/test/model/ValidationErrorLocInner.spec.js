...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LivepeerAiRunner.ValidationErrorLocInner();
  });
  ...
  describe('ValidationErrorLocInner', function() {
    it('should create an instance of ValidationErrorLocInner', function() {
      ...
      //var instance = new LivepeerAiRunner.ValidationErrorLocInner();
      //expect(instance).to.be.a(LivepeerAiRunner.ValidationErrorLocInner);
    });
