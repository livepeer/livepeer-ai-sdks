...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LivepeerAiRunner.ValidationError();
  });
  ...
  describe('ValidationError', function() {
    it('should create an instance of ValidationError', function() {
      ...
      //var instance = new LivepeerAiRunner.ValidationError();
      //expect(instance).to.be.a(LivepeerAiRunner.ValidationError);
    });
