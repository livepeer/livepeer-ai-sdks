...
import livepeer_ai_typed.models
from livepeer_ai_typed import rest
from livepeer_ai_typed.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(livepeer_ai_typed.models, klass)
